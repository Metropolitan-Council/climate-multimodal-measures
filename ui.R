...
# Main Container
div(
  class = "main-container",  # Custom Class for Styling
  ...
  div(
    ...
    tags$img(src = "main-logo.png", height = "50px", style = "margin-right: 15px;"),
...
page_navbar(
  ...
  nav_panel(title = "Sources", page_fillable(card(
...
#   title = div(
#     style = "background-color: #A5BAD5;  /* Light Blue Background */
...
#       ),
#       div(
#         style = "font-family: 'Medium-Condensed', Arial, sans-serif;
#                  font-size: 24px; font-weight: bold; color: white;",
#         "Metropolitan Council"
#       )
#     ),
#     
#     # Navigation Buttons (Below the Title & Logo)
#     div(
#       style = "display: flex; justify-content: center; gap: 20px; width: 100%; margin-top: 10px;",
#       a(href = "#", class = "nav-link", "Calculations"),
#       a(href = "#", class = "nav-link", "Sources")
#     )
#   ),
#   
#   bg = "#A5BAD5",  # Ensures the navbar background matches
#   
#   nav_panel(
#     title = "Calculations",
#     navset_pill_list(
...
#               height = "auto",
#               tags$div(
#                 style = "background-color: #EDEDED; /* Custom Deep Blue Background */
#            border-left: 5px solid #002b5c; /* Shiny Default Blue Border */
#            padding: 12px;
#            font-size: 14px;
#            font-weight: bold;
